<?php
/**
 * Contact form endpoint — Metrología landing page.
 *
...
if (!is_readable($lib . '/bootstrap.php')) {
    error_log('[shively-contact:metrologia] bootstrap.php missing at ' . $lib);
...
contact_handle([
    'tag'            => 'metrologia',
    'form_source'    => '/shivelybros-gc/metrologia/index.html',
    'subject_prefix' => '[Sitio web · Metrología]',
    'origin_label'   => 'Landing Metrología',
