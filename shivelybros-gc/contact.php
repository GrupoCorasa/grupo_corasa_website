<?php
/**
 * Contact form endpoint — Main Shively Bros landing page.
 *
...
if (!is_readable($lib . '/bootstrap.php')) {
    error_log('[shively-contact:home] bootstrap.php missing at ' . $lib);
...
contact_handle([
    'tag'            => 'home',
    'form_source'    => '/shivelybros-gc/index.html',
    'subject_prefix' => '[Sitio web]',
    'origin_label'   => null,
