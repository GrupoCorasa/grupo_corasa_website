<?php
/**
 * Contact form endpoint — Abrasivos landing page.
 *
...
if (!is_readable($lib . '/bootstrap.php')) {
    error_log('[shively-contact:abrasivos] bootstrap.php missing at ' . $lib);
...
contact_handle([
    'tag'            => 'abrasivos',
    'form_source'    => '/shivelybros-gc/abrasivos/index.html',
    'subject_prefix' => '[Sitio web · Abrasivos]',
    'origin_label'   => 'Landing Abrasivos',
