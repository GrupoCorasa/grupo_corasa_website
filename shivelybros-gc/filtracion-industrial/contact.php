<?php
/**
 * Contact form endpoint — Filtración Industrial landing page.
 *
...
if (!is_readable($lib . '/bootstrap.php')) {
    error_log('[shively-contact:filtracion] bootstrap.php missing at ' . $lib);
...
contact_handle([
    'tag'            => 'filtracion',
    'form_source'    => '/shivelybros-gc/filtracion-industrial/index.html',
    'subject_prefix' => '[Sitio web · Filtración]',
    'origin_label'   => 'Landing Filtración Industrial',
