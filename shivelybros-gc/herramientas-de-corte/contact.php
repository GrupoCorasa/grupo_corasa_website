<?php
/**
 * Contact form endpoint — Herramientas de Corte landing page.
 *
...
if (!is_readable($lib . '/bootstrap.php')) {
    error_log('[shively-contact:herramientas-de-corte] bootstrap.php missing at ' . $lib);
...
contact_handle([
    'tag'            => 'herramientas-de-corte',
    'form_source'    => '/shivelybros-gc/herramientas-de-corte/index.html',
    'subject_prefix' => '[Sitio web · Herramientas de Corte]',
    'origin_label'   => 'Landing Herramientas de Corte',
